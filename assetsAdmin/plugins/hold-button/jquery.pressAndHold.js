...
;(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		init: function() {
			...
			progressIndicatorHTML = '<div class="holdButtonProgress" style="height: 100%; width: 25%; position: absolute; top: 0; left: -100%; background-color:' + this.settings.progressIndicatorColor + '; opacity:' + this.settings.progressIndicatorOpacity + ';"></div>';
