...
//            {
//		$dataStore="";
//		$fileCount=count($_FILES['file_employee_upload']['name']);
//		
...
//            for($i=0; $i<$clientCnt; $i++)
//            {
//		//print_r($files['file_employee_upload']['name']); 
//		//print_r($_POST['update_emp'][$i]);
...
//		    {
//		     $target_file=$_POST['file_employee_upload_old'][$i];
//		    }
//		     //echo $target_file;exit;
//		    $data= array(
//			'client_comp'=>$_POST['client_comp'][$i],
...
//			'location'=>$_POST['location'][$i],
//			'reason_desc'=>$_POST['empReasonDesc'][$i],
//			'file_employee_upload'=>$target_file,
//		    );
//		    //echo "<pre>";
//		    //print_r($data);
...
//		    {
//			$target_file=$_POST['file_student_upload_old'][$j];
//		    }
//		    $data= array(
...
//			'file_student_upload'=>$target_file,
//		    );
//		    $this->db->where('id', $line_id);
...
//        }
	...
	function updatelogindata($id)
	{
		...
		for($j=0; $j<$counter; $j++)
		{
		    ...
		    if($_FILES['file_employee_upload']['name']=="")
		    {
			$dataStore=$_POST['file_employee_upload_old'][$i];
		    }
		}
		     //echo $target_file;exit;
		    $data= array(
		...
		if($_POST['update_educ'][$j]=='UPDATE')
		{
			...
			if($_FILES['file_student_upload']['name']=="")
			{
			    $dataStore=$_POST['file_student_upload_old'][$j];
			}
		    }
		    $data= array(
			'degree'=>$_POST['degree'][$j],
