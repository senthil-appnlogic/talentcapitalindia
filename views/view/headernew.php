...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		<div id="header" class="header navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="<?php echo site_url('directemployee/dashboard');?>" class="navbar-brand"> <img width="95px" height="62px"   style="margin-top:-18px;" src="<?php echo base_url();?>assetsAdmin/images/logonew.png" alt="Talent Capital Admin"></a>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo base_url($this->session->userdata('profile_pic')); ?>" alt="" /> 
	<span class="hidden-xs"><?php $session_data=$this->session->userdata('directempname'); echo  $session_data?></span> <b class="caret"></b>
						...
						<ul class="dropdown-menu animated fadeInLeft">
							...
							<!--<li class="divider"></li>-->
							<?php $session_id=$this->session->userdata('directempid');?>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							...
							<img width="250" height="100" src="<?php echo base_url($this->session->userdata('profile_pic')); ?>" alt="" /></a>
						</div>
						<div class="info">
							Talent Capital
							<small>DirectEmployee</small>
						</div>
					</li>
				</ul>
				<!-- end sidebar user -->
				...
				<ul class="nav">
					...
					<li class="has-sub <?php if($this->uri->segment(2)=="dashboard"){echo "active";}?>">
						<a href="<?php echo site_url('directemployee/dashboard');?>">
