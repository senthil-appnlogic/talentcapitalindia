...
<div class="content" id="content">
	...
	<div class="col-12 ui-sortable">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Clients Form</h4>
		</div>
		...
		<?php } ?>
		    ...
		    <form action="<?php echo site_url('admin/clients'); ?>" class="" id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">
			<div class="col-md-6 col-md-offset-3">
			    <div class="form-group">
                                <h2 class="headingLine" id="language">Clients Details</h2>
                            </div>
                            <div class="form-group">
                                <label>Client Company Name<span style="color:#EB8B11">*</span></label>
                                <input class="form-control input-md" name="client" type="text" placeholder="Enter Language">
                            </div>
