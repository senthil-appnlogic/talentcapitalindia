...
<div class="content" id="content">
                ...
                <div class="col-12 ui-sortable">
                    ...
                    <div data-sortable-id="form-stuff-5" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Location Form</h4>
                        </div>
			...
			{?>
			    ...
			    <?php
			     ...
			     <p>
				<a class="btn btn-primary btn-sm " href="<?php echo site_url('admin/location')?>"><i class="fa fa-plus fa-1x"></i> <span class="f-s-14 f-w-500">Add</span></a>
			    </p>
					...
					<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					  <thead>
						...
						<td>
                                                    ...
                                                    <a onclick="locationDelete();" id="delete_box" href="<?php echo site_url('admin/locationDelete/'.$row['id'])?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> </a></td>
						</tr>
