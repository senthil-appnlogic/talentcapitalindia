...
<div class="content" id="content">
			...
			{?>
			    ...
			    <?php
			     ...
			     <p>
				<a class="btn btn-primary btn-sm " href="<?php echo site_url('admin/clients')?>"><i class="fa fa-plus fa-1x"></i> <span class="f-s-14 f-w-500">Add</span></a>
			    </p>
					...
					<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					  <thead>
						...
						<td>
                                                    ...
                                                    <a onclick="langDelete();" id="delete_box" href="<?php echo site_url('admin/clientsDelete/'.$row['id'])?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> </a></td>
						</tr>
