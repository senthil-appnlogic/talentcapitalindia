...
<div class="content" id="content">
	...
	<div class="col-12 ui-sortable">
		...
		<?php } ?>
		    ...
		    <form action="<?php echo site_url('admin/mailToCandiate'); ?>" class=""  id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">
			<div class="col-md-6 col-md-offset-3">
			    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="jquery-tagIt-primary" class="form-control input-md" name="email" type="text" placeholder="Candidate Email">
                            </div>
			   <!-- <div class="form-group">
