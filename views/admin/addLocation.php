...
<div class="content" id="content">
	...
	<div class="col-12 ui-sortable">
		...
		<?php } ?>
		    ...
		    <form action="<?php echo site_url('admin/location'); ?>" class="" id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">
			<div class="col-md-6 col-md-offset-3">
			    <div class="form-group">
                                <h2 class="headingLine" id="candidate">Location Details</h2>
                            </div>
                            <div class="form-group">
                                <label>Location<span style="color:#EB8B11">*</span></label>
                                <input class="form-control input-md" name="location" type="text" placeholder="Enter Location">
                            </div>
