...
<div class="content" id="content">
	...
	<div class="col-12 ui-sortable">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Skills Form</h4>
		</div>
		...
		<?php } ?>
		    ...
		    <form action="<?php echo site_url('admin/skills'); ?>" class="" id="form_validation" method="post" name="form_validation" enctype="multipart/form-data">
			<div class="col-md-6 col-md-offset-3">
			    <div class="form-group">
                                <h2 class="headingLine" id="candidate">Skills Details</h2>
                            </div>
                            <div class="form-group">
                                <label>Skill<span style="color:#EB8B11">*</span></label>
                                <input class="form-control input-md" name="skill" type="text" placeholder="Enter Skill">
                            </div>
