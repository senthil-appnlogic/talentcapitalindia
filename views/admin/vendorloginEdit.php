                        ...
                        <div class="panel-body">
                            <form id="form_validation" action=""   enctype="multipart/form-data" role="form" method="post">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input name="username" value="<?php echo $vendorloginEditRow[0]['name']?>"  class="form-control input-md" type="text" placeholder="Vendor Name">
                                    </div>
                                    <div class="form-group">
                                        <label>Mobile Number <span style="color:#EB8B11">*</span> </label>
                                        <input name="mobileno"  value="<?php echo $vendorloginEditRow[0]['mobile_number']?>"  class="form-control input-md" type="text" placeholder="Number">
                                    </div>
                                    <div class="form-group">
                                        <label>Email <span style="color:#EB8B11">*</span> </label>
                                        <input name="email" value="<?php echo $vendorloginEditRow[0]['email']?>" class="form-control input-md" type="email" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                        <label>Pan Attach (Proof)  <span style="color:#EB8B11">*</span> </label>
                                         <input name="vendor_pancard_no" value="<?php echo $vendorloginEditRow[0]['pan_attach_no']?>" class="form-control input-md" type="text" placeholder="Please enter your 10-digit Pan card number">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="" value="<?php echo site_url($vendorloginEditRow[0]['pan_attach_copy'])?>" class="form-control" readonly >
                                        </div>
                                    </div>
				     <div class="form-group">
                                        <label>Address (Attach Proof) <span style="color:#EB8B11">*</span> </label>
                                        <textarea id="comment" class="form-control"  name="address_text" rows="5"><?php echo $vendorloginEditRow[0]['address_text']?></textarea>
                                    </div>
                                    <div class="form-group">					
                                       <img src="<?php echo site_url($vendorloginEditRow[0]['pan_attach_copy'])?>" class="img-resposive" width="300" height="200" id="PanImgPreview">
                                    </div>
					...
					<label>Bank A/c Details (Attach cancelled cheque) <span style="color:#EB8B11">*</span> </label>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="" value="<?php echo site_url($vendorloginEditRow[0]['bank_attach_cheque'])?>" class="form-control" readonly >
                                        </div>
                                    </div>				    
                                </div>
                            </form>
