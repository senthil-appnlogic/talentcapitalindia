...
<div class="content" id="content">
			...
			{?>
			    ...
			    <?php
			     ...
			     <p>
				<a class="btn btn-primary btn-sm " href="<?php echo site_url('admin/languages')?>"><i class="fa fa-plus fa-1x"></i> <span class="f-s-14 f-w-500">Add</span></a>
			    </p>
				<div class="table-responsive" style="border: none">
					<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					  <thead>
					    ...
					    <tbody>
						<?php 
					     foreach($langDetails as $row) {  ?>
					       
						<tr class="oddClass even gradeC" >
						<td><?php echo $row['language']; ?></td>					    
						<td>
                                                    <a href="#" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> </a>
                                                    <a onclick="langDelete();" id="delete_box" href="<?php echo site_url('admin/languageDelete/'.$row['id'])?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> </a></td>
						</tr>
