                ...
                <div class="col-12 ui-sortable">
                    ...
                    <div data-sortable-id="form-stuff-5" class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form id="form_validation" action="<?php base_url('internalemployee/intEmpEditUser/'.$userEdit[0]['id']);?>"   enctype="multipart/form-data" role="form" method="post">
				    ...
				    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input value="<?php echo $userEdit[0]['user_name'] ?>" name="username"  class="form-control input-md" type="text" placeholder="Name">
                                    </div>
				    <div class="form-group">
                                        <label>Email</label>
                                        <input value="<?php echo $userEdit[0]['email'] ?>" name="email"  class="form-control input-md" type="text" placeholder="Name">
                                    </div>
                                    <div class="form-group">
